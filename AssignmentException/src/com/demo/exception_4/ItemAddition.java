...
public class ItemAddition {
	...
	public static void addItems() {
		...
		for (int i = 0; i < 2; i++) {
			...
			System.out.println("Enter the name the Item for Add");
	...
	public static void purchaseItems() {
		...
		System.out.println("How many items you want to purchaseItems");
		...
		System.out.println("The bill of the purchased Items " + bill+"Rs.");
